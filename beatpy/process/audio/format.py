...
class ProcessAudioFormat:
    ...
    @staticmethod
    def convert_to_mp3(*, path_in: Path, quality: T_Quality = DEFAULT_QUALITY, delete_old: bool = True) -> Path:
        ProcessAudioFormat._convert(path_in=path_in, format_out="mp3", quality=quality, delete_old=delete_old)
